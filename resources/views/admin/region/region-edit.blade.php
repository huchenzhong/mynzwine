...
<div class="page-container">
    <form action="/admin/region/region-edit/{{$id}}" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Region Name：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{\App\Admin\Region::find($id)->name}}" id="" name="name">
                <p id="nameError"></p>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="postage" id="" value="{{\App\Admin\Region::find($id)->postage}}" class="input-text" style="width:90%">
                NZD
                <p id="priceError"></p>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                >{{\App\Admin\Region::find($id)->desc}}</textarea>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $('#priceError').html("{{$errors->first('postage')}}").css({'color':'red','font-size':'12px'});
    @endif
    @elseif(session('msg'))
