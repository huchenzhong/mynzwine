...
<div class="page-container">
    <form action="/admin/wine/wine-add" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="price" id="" value="{{old('price')}}" class="input-text" style="width:90%">
                NZD
                <p id="priceError"></p>
            </div>
        </div>
