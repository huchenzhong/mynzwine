...
<head>
    ...
    <![endif]-->
    <title>Winery Edit</title>
    <meta name="keywords" content="H-ui.admin v3.1,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
    <meta name="description" content="H-ui.admin v3.1，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add" action="/admin/winery/winery-edit/{{$id}}" method="post" enctype="multipart/form-data">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>Winery ID：</label>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                {{\App\Admin\Winery::find($id)->name}}
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>Phone: </label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{\App\Admin\Winery::find($id)->phone}}" id="phone" name="phone">
                <p id="phoneError"></p>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="email" class="input-text"  placeholder="@" id="email" value="{{\App\Admin\Winery::find($id)->email}}" name="email">
                <p id="emailError"></p>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <input type="text" class="input-text"  id="address" name="address" value="{{\App\Admin\Winery::find($id)->address}}">
                <p id="addressError"></p>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="url" class="input-text" value="{{\App\Admin\Winery::find($id)->url}}" placeholder="http://" id="url" name="url">
                <p id="urlError"></p>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    $(function(){
        ...
        @endif
        @if($errors->has('url'))
        $('#urlError').html("{{$errors->first('url')}}").css({'color':'red','font-size':'12px'});
        @endif
        @elseif(session('msg'))
